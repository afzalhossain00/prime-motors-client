...
const Banner = () => {
    return (
        <div className="hero min-h-screen mb-5" style={{ backgroundImage: `url("https://images.pexels.com/photos/8991394/pexels-photo-8991394.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")` }}>
